...
class CorrelationContextManager(dctx_api.CorrelationContextManager):
    ...
    def current_context(self,) -> typing.Optional[dctx_api.CorrelationContext]:
        ...
        """
        return BaseContext.value(self.slot_name)
    ...
    def use_context(
        ...
        """
        snapshot = BaseContext.value(self.slot_name)
        BaseContext.set_value(self.slot_name, context)
        try:
            yield context
        finally:
            BaseContext.set_value(self.slot_name, snapshot)
